...
$cuda_cmd $dir/_pretrain_dbn.log \
  steps/pretrain_dbn_aenc.sh --use-gpu-id 0 --feature-transform $feature_transform --nn-depth 5 --hid-dim 1024:1024:1024:1024:$node --rbm-iter 3 $data/train $dir
. ./path.sh
