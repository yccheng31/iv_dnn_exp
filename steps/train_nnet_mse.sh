...
labels_tr="$feats_tr nnet-forward --use-gpu-id=-1 $feature_transform ark:- ark:- |"
labels_cv="$feats_cv nnet-forward --use-gpu-id=-1 $feature_transform ark:- ark:- |"
steps/train_nnet_mse_scheduler.sh \
